...
CUDA_VISIBLE_DEVICES=0 python -m tevatron.retriever.driver.encode \
    ...
    --query_max_len 32 \
    --passage_max_len 128 \
    --dataset_path /home/jmcoelho/11797_Project/data/subtask-1/queries.jsonl \
    --encode_output_path $EMBEDDING_OUTPUT_DIR/query-touche.pkl



set -f && OMP_NUM_THREADS=24 python -m tevatron.retriever.driver.search \
    --query_reps $EMBEDDING_OUTPUT_DIR/query-touche.pkl \
    --passage_reps $EMBEDDING_OUTPUT_DIR/corpus.marco.v2.passage.segmented.*.pkl \
    --depth 100 \
    --batch_size 128 \
    --save_text \
    --save_ranking_to $EMBEDDING_OUTPUT_DIR/run.touche.txt
