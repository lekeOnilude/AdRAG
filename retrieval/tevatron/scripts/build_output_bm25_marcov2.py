...
PATH_RUN = f"/data/group_data/cx_group/query_generation_data/temporary_indexes/bm25/marco_v2_segmented/run.{QUERIES}.txt"
...
PATH_OUT = f"./output/{QUERIES}/bm25.jsonl"
