...
class ModelArguments:
    ...
    dim_reduction_factor: int = field(
        default=None,
        metadata={"help": "train a projection alongside the model to reduce dims."},
    )
    # for Jax training
...
class DataArguments:
    ...
    add_markers: bool = field(
        default=False,
        metadata={"help": "add Title and Text markers to passage representation"},
    )
